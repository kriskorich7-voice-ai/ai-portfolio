...
import { findInsight, formatInsightDate } from '../data/insights.js';
    ...
    <section className="container-page py-16 sm:py-20">
      ...
      <article className="mx-auto mt-8 max-w-3xl">
        ...
        <footer className="mt-6 flex flex-col gap-4 border-t border-white/5 pt-8 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-sm font-semibold text-white">Kris Korich</p>
            <p className="mt-0.5 text-sm text-slate-400">
              Partnerships &amp; BD at Deepgram · San Diego, CA
            </p>
          </div>
          <Link
            to="/insights"
          ...
          >
            <BackArrow /> Back to all insights
          </Link>
        </footer>
      </article>
    </section>
